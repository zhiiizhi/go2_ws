...
def generate_launch_description():
    ...
    descr_pkg_share = launch_ros.substitutions.FindPackageShare(
        package="m20_description"
    ).find("m20_description")
    ...
    default_model_path = os.path.join(descr_pkg_share, "urdf/m20_description.urdf")
    ...
    declare_robot_name = DeclareLaunchArgument(
        "robot_name", default_value="m20", description="Robot name"
    )
    ...
    declare_world_init_z = DeclareLaunchArgument("world_init_z", default_value="0.95")
