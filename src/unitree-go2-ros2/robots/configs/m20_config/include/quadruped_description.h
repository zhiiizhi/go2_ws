...
namespace champ
{
    namespace URDF
    {
        void loadFromHeader(champ::QuadrupedBase &base)
        {
            ...
            //   lower_leg.setOrigin(0, 0.0984, -0.25)  // X=0，向前偏移
            //
            ...
            base.lh.lower_leg.setOrigin(0, 0.0984, -0.25, 0, 0, 0);
            base.lh.foot.setOrigin(0, 0.059676, -0.25, 0, 0, 0);

            // 右后腿（knee 向前弯曲，X 为负）
            base.rh.hip.setOrigin(-0.3141, -0.0685, 0, 0, 0, 0);
            base.rh.upper_leg.setOrigin(0, 0, 0, 0, 0, 0);
            base.rh.lower_leg.setOrigin(0, -0.0984, -0.25, 0, 0, 0);
            base.rh.foot.setOrigin(0, -0.059676, -0.25, 0, 0, 0);
        }
    }
}
#endif
