...
def generate_launch_description():
    ...
    pkg_share = launch_ros.substitutions.FindPackageShare(package="m20_description").find("m20_description")
    default_model_path = os.path.join(pkg_share, "urdf/m20_description.urdf")
